...
export function StartBarChat() {
  ...
  return (
    <PopoverPrimitive.Root onOpenChange={() => setIsMinimized(false)}>
      ...
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content
          ...
          className="w-82 px-2"
        >
          <div className="border-border border-2 shadow-lg">
            <div className="from-titleBarFrom to-titleBarTo text-highlightText flex w-full items-center justify-between bg-gradient-to-r p-1">
              <div>
